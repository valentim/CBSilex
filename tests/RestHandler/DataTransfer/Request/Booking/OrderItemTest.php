...
class OrderItemTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf("Clickbus\\RestHandler\DataTransfer\\Request\\Booking\\OrderItem", $this->object);
    }
    ...
    {
        $this->assertSame("Clickbus\\RestHandler\DataTransfer\\Request\\Booking\\OrderItem", $this->object->getData()->name);
    }
