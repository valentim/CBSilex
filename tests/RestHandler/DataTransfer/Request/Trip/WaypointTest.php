...
class WaypointTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf("Clickbus\\RestHandler\DataTransfer\\Request\\Trip\\Waypoint", $this->object);
    }
    ...
    {
        $this->assertSame("Clickbus\\RestHandler\DataTransfer\\Request\\Trip\\Waypoint", $this->object->getData()->name);
    }
